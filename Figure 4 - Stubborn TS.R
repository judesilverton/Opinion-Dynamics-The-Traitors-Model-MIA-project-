...
#Opinion dynamics model: Chapter 4, Figure 4 and Figure 6
...
write.csv(max, "~/Opinion Dynamics/Figure 4.csv")
...
pdf("Figure 4.pdf", width =8, height = 6)
...
pdf("Figure 6.pdf", width =6, height = 5)
